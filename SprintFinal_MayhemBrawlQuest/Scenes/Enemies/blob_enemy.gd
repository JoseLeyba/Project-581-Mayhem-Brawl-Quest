...
@export var slime_scene = preload("res://Scenes/Enemies/slime_ball.tscn")
...
func _on_timer_timeout():
	can_jump = true # Allow jumping when the timer resets
...
func shoot_slime():
	...
	var slime = slime_scene.instantiate() as RigidBody2D

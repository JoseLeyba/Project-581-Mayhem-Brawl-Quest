...
#List to keep track of players in the water area
var players_in_area = []
...
#This function will be called if something enters the water
...
#This function is called whenever a body exits the water area

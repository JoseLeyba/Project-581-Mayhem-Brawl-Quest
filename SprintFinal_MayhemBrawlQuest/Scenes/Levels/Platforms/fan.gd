...
#List to keep track of players in the fan area
var players_in_area = []
...
#This function will be called if something enters the fan
...
#This function is called whenever a body exits the fan area

...
#List to keep track of players in the spike area
var players_in_area = []
...
#This function will be called if something enters the spikes
...
#This function is called whenever a body exits the spike area
